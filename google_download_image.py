...
# 读取关键字文件
csv_file = csv.reader(open(BASE_DIR + "\keywords.csv", "r", encoding='UTF-8'))
...
def download_images(csv_file):
   ...
   for key_word in csv_file:
       arguments = {"keywords": key_word, "limit": 200, "print_urls": True,
